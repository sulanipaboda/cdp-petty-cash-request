...
const BranchForm = ({ onSubmit, initialData = null, onCancel, isReadOnly = false }) => {
                    ...
                    <div className="relative z-10 flex items-center gap-4">
                        ...
                        <div>
                            <h1 className="text-lg font-black text-white uppercase tracking-tighter leading-none">
                                {isReadOnly ? 'View Branch' : isEditing ? 'Refine Branch' : 'Branch Initialization'}
                            </h1>
                            <p className="text-primary-50 mt-1 text-[9px] font-medium opacity-80 uppercase tracking-widest leading-none">
                                {isReadOnly ? 'View Mode' : 'Geographic & Logistics Profile'}
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-6">
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="relative group">
                                    ...
                                    <input
                                        ...
                                        className="w-full pl-12 pr-6 py-2.5 bg-gray-50/50 dark:bg-gray-800/50 border-2 border-transparent focus:border-primary-600/20 focus:bg-white dark:focus:bg-gray-800 rounded-xl outline-none transition-all text-[12px] font-bold text-gray-900 dark:text-gray-100 disabled:opacity-70 disabled:cursor-not-allowed"
                                        required
                                        disabled={isReadOnly}
                                    />
                                </div>
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="relative group">
                                    ...
                                    <select
                                        ...
                                        className="w-full pl-12 pr-6 py-2.5 bg-gray-50/50 dark:bg-gray-800/50 border-2 border-transparent focus:border-primary-600/20 focus:bg-white dark:focus:bg-gray-800 rounded-xl outline-none transition-all text-[12px] font-bold text-gray-900 dark:text-gray-100 appearance-none disabled:opacity-70 disabled:cursor-not-allowed"
                                        required
                                        disabled={isReadOnly}
                                    >
                    ...
                    <div className="pt-6 border-t border-gray-100 dark:border-gray-800 flex items-center justify-end gap-5">
                        <button
                            type="button"
                            onClick={onCancel}
                            className={`text-[9px] font-black uppercase tracking-[0.2em] transition-colors ${isReadOnly ? 'bg-gray-100 dark:bg-gray-800 text-gray-600 px-6 py-2.5 rounded-xl hover:bg-gray-200' : 'text-gray-400 hover:text-primary-600 dark:hover:text-primary-400'}`}
                        >
